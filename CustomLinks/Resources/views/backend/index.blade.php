...
@section('title', trans('cms::cms.custom_links'))
@section('content_header', trans('cms::cms.custom_links'))
@section('breadcrumb')
    <ol class="breadcrumb">
        <li class="active">@lang('cms::cms.custom_links')</li>
    </ol>
@endsection
...
@section('content')
    <div class="box">
        <div class="box-header with-border">
            <a class="btn btn-primary btn-xs" href="{{ route('backend.custom-links.create', request()->query()) }}">@lang('cms::cms.create')</a>
        </div>
                    ...
                    <tbody>
                        @forelse ($posts as $i => $post)
                            <tr>
                                ...
                                <td align="center">
                                    <a class="btn btn-primary btn-xs" href="{{ route('backend.custom-links.edit', [$post->id] + request()->query()) }}"><i class="fa fa-pencil"></i></a>
                                    <a class="btn btn-danger btn-xs" href="{{ route('backend.custom-links.trash', $post->id) }}" onclick="return confirm('@lang('cms::cms.are_you_sure_to_delete_this')?')"><i class="fa fa-trash-o"></i></a>
                                    @can('backend custom links delete')
                                        <a class="btn btn-danger btn-xs" href="{{ route('backend.custom-links.delete', $post->id) }}" onclick="return confirm('@lang('cms::cms.are_you_sure_to_delete_this_permanently')?')"><i class="fa fa-trash-o"></i></a>
                                    @endcan
                                </td>
                            </tr>
                        @empty
