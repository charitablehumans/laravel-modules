...
@section('content')
    <div class="box">
        <div class="box-header with-border">
            <a class="btn btn-primary btn-xs" href="{{ route('backend.roles.create', request()->query()) }}">@lang('cms::cms.create')</a>
        </div>
                    ...
                    <tbody>
                        @forelse ($roles as $i => $role)
                            <tr>
                                ...
                                <td align="center">
                                    <a class="btn btn-primary btn-xs" href="{{ route('backend.roles.edit', [$role->id] + request()->query()) }}"><i class="fa fa-pencil"></i></a>
