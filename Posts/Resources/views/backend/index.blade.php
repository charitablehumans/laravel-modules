...
@section('content')
    <div class="box">
        <div class="box-header with-border">
            <a class="btn btn-default btn-sm" href="{{ route('backend.posts.create', request()->query()) }}">@lang('cms::cms.create')</a>
        </div>
                    ...
                    <tbody>
                        @forelse ($posts as $i => $post)
                            <tr>
                                ...
                                <td align="center">
                                    <a class="btn btn-default btn-xs" href="{{ route('backend.posts.edit', [$post->id] + request()->query()) }}"><i class="fa fa-pencil"></i></a>
