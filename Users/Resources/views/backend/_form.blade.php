        ...
        <div class="box">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input autocomplete="off" class="form-control datepicker input-sm" data-date-format="yyyy-mm-dd" name="date_of_birth" required type="text" value="{{ request()->old('date_of_birth', $user->date_of_birth) }}" />
                ...
                <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">@lang('cms::cms.roles')</h3>
                    ...
                    @can('backend permissions')
                        <div class="col-md-6">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">@lang('cms::cms.permissions')</h3>
                                    <div class="box-tools pull-right">
                                        <button class="btn btn-box-tool" data-original-title="Collapse" data-toggle="tooltip" data-widget="collapse" type="button">
                                            <i class="fa fa-minus"></i>
                                        </button>
    ...
    <div class="col-md-3">
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-original-title="Collapse" data-toggle="tooltip" title="" data-widget="collapse" type="button">
                        <i class="fa fa-minus"></i>
                    </button>
                </div>
            </div>
            <div class="box-body">
                <input class="images_media_id" name="usermetas[images][]" type="hidden" value="" />
                <u>
                    <a
                        data-fancybox
                        data-type="iframe"
                ...
                <ul class="list-inline sortable-list-group" id="images">
                    <template class="hidden" id="images_template">
                        <li>
                            <input class="images_media_id" name="usermetas[images][]" type="hidden" value="$images_media_id" />
                    ...
                    @foreach ($user->getUsermetaByKey('images')->getMedia() as $medium)
                        <li>
                            <input class="images_media_id" name="usermetas[images][]" type="hidden" value="{{ $medium->id }}" />
                            <div style="position: relative;">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">@lang('cms::cms.others')</h3>
                <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-original-title="Collapse" data-toggle="tooltip" title="" data-widget="collapse" type="button">
                        <i class="fa fa-minus"></i>
                    </button>
            ...
            <div class="box-body">
                @if (config('cms.users.usermetas.job'))
                    <div class="form-group">
                        <label>@lang('cms::cms.job')</label>
                        <input class="form-control input-sm" name="usermetas[job]" type="text" value="{{ request()->old('usermetas.job', $user->getUsermetaValueByKey('job')) }}" />
                    </div>
                @endif
            </div>
        </div>
