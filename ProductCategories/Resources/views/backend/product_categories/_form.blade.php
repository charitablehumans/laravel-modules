        ...
        <div class="box">
            <div class="box-body">
                ...
                @foreach (config('app.languages') as $languageCode => $languageName)
                    @if ($term->id)
                        @php $languageHref = route('backend.product-categories.edit', ['id' => $term->id, 'locale' => $languageCode]) @endphp
                    @else
                        @php $languageHref = route('backend.product-categories.create', ['locale' => $languageCode]) @endphp
                    @endif
