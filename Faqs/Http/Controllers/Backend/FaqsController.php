...
namespace Modules\Faqs\Http\Controllers\Backend;

use Illuminate\Http\Request;

class FaqsController extends \Modules\Posts\Http\Controllers\Backend\PostsController
{
    protected $model;

    public function __construct()
    {
        $this->model = new \Modules\Faqs\Models\Faqs;
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('faqs::backend/index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('faqs::backend/create', $data);
    }
    ...
    public function edit($id, Request $request)
    {
        ...
        return view('faqs::backend/edit', $data);
    }
}
