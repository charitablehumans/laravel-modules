        ...
        <div class="box">
            <div class="box-body">
                ...
                @foreach (config('app.languages') as $languageCode => $languageName)
                    @if ($post->id)
                        @php $languageHref = route('backend.locations.edit', ['id' => $post->id, 'locale' => $languageCode]) @endphp
                    @else
                        @php $languageHref = route('backend.locations.create', ['locale' => $languageCode]) @endphp
                    @endif
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">@lang('cms::cms.location')</h3>
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control input-sm" name="post_locations[address]" type="text" value="{{ $post->getAddress() }}" />
                                    <i class="text-danger">{{ $errors->first('address') }}</i>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 col-xs-6">
                                        <label>@lang('validation.attributes.latitude')</label>
                                        <input class="form-control input-sm text-right" name="post_locations[latitude]" step="any" type="number" value="{{ $post->getLatitude() }}" />
                                    </div>
                                    <div class="col-md-6 col-xs-6">
                                        <label>@lang('validation.attributes.longitude')</label>
                                        <input class="form-control input-sm text-right" name="post_locations[longitude]" step="any" type="number" value="{{ $post->getLongitude() }}" />
                                    </div>
                                </div>
                            </div>
                        </div>
