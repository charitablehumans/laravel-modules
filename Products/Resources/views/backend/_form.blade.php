        ...
        <div class="box">
            <div class="box-body">
                ...
                @foreach (config('app.languages') as $languageCode => $languageName)
                    @if ($post->id)
                        @php $languageHref = route('backend.products.edit', ['id' => $post->id, 'locale' => $languageCode]) @endphp
                    @else
                        @php $languageHref = route('backend.products.create', ['locale' => $languageCode]) @endphp
                    @endif
