...
class CreateDokuMyshortcartTransactionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        \Schema::create((new DokuMyshortcartTransactions)->getTable(), function (Blueprint $table) {
    ...
    {
        \Schema::dropIfExists((new DokuMyshortcartTransactions)->getTable());
    }
}
