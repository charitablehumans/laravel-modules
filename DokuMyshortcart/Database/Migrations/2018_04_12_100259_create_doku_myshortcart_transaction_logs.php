...
class CreateDokuMyshortcartTransactionLogs extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        \Schema::create((new DokuMyshortcartTransactionLogs)->getTable(), function (Blueprint $table) {
    ...
    {
        \Schema::dropIfExists((new DokuMyshortcartTransactionLogs)->getTable());
    }
}
